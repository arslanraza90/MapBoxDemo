...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/mapbox/mapbox-maps-ios.git", from: "10.10.1"),
        .package(url: "https://github.com/mapbox/mapbox-directions-swift.git", from: "2.9.1"),
        .package(url: "https://github.com/mapbox/mapbox-navigation-ios.git", from: "2.9.1"),
        .package(url: "https://github.com/YAtechnologies/GoogleMaps-SP.git", .upToNextMinor(from: "7.2.0"))
//        .package(url: "https://github.com/googlemaps/google-maps-ios.git", from: "7.3.0"),
    ...
    targets: [
        ...
        .testTarget(
            name: "MapBoxSwiftTests",
            dependencies: ["MapBoxSwift"]),
    ]
)
